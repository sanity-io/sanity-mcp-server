...
The project includes a GitHub Pages site that automatically generates and publishes quality reports. You can access the latest quality report at:

[https://sanity-io.github.io/sanity-mcp-server/](https://sanity-io.github.io/sanity-mcp-server/)

**Note:** This report is generated by a GitHub Actions workflow that runs whenever:
- Changes are pushed to the main branch
- A new release tag is created

If you've just created a tag or pushed to main, please allow a few minutes for the workflow to complete and deploy the report.

The GitHub Pages report includes:
- Code quality metrics (warnings, errors, duplications, complex functions)
- Test coverage statistics
- Test results summary with a colorful, interactive interface
...
- Test Coverage: 0% (Coverage report not generated)
- ESLint Issues: 0 errors, 48 warnings
- Complex Functions: 129
- Code Duplication: 0%

#### Detailed Quality Information

- [📊 Interactive Quality Metrics Dashboard](https://sanity-io.github.io/sanity-mcp-server/index.html) - Visual trends of code quality over time
- [📝 Quality Improvement Recommendations](https://sanity-io.github.io/sanity-mcp-server/index.html) - Prioritized list of suggested improvements
- [📈 Raw Quality Data](https://sanity-io.github.io/sanity-mcp-server/test-results.json) - Test results data

**Note:** These GitHub Pages reports will be available after the GitHub Actions workflow runs following the tag creation. The workflow is triggered automatically when a new tag is pushed or changes are made to the main branch.
