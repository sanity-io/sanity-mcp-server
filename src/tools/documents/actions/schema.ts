...
export type PublishDocumentParamsType = z.infer<
  typeof PublishDocumentParamsSchema
>;

export type PublishDocumentsParamsType = z.infer<
  typeof PublishDocumentsParamsSchema
>;
