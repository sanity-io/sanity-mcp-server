import type {RawRequestOptions, SanityClient} from '@sanity/client'
...
export type ActionDocumentVersionCreate = 'sanity.action.document.version.create'
export type ActionDocumentVersionUnpublish = 'sanity.action.document.version.unpublish'
...
export async function actionRequest<T, K>(client: SanityClient, req: T): Promise<K> {
